...
void subset1(ll i, ll sum)
{
    ...
    {
        subset1(i + 1, sum);
        subset1(i + 1, sum + v1[i]);
        subset1(i + 1, sum + (2 * v1[i]));
    }
}
void subset2(ll i, ll sum)
{
    s2.push_back(sum);
    if (i < v2.size())
    {
        subset2(i + 1, sum);
        subset2(i + 1, sum + v2[i]);
        subset2(i + 1, sum + (2 * v2[i]));
    }
}
int main()
{
